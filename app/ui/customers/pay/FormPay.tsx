			...
			<div className="rounded-md bg-gray-50 p-4 md:p-6">
				...
				<div className="mb-4">
					...
					<div className="relative mt-2 rounded-md">
						...
						<UserIcon className="pointer-events-none absolute top-1/2 h-[18px] w-[18px] left-3 -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
					...
					<div className="relative mt-2 rounded-md">
						<div className="relative">
							<select
								id="invoice"
								name="invoice"
								className="peer block w-full rounded-md border border-gray-200 py-2 pl-10 text-[16px] text-sm outline-2 placeholder:text-gray-500"
